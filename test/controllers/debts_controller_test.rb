...
class DebtsControllerTest < ActionController::TestCase
  ...
  test "should create debt" do
    assert_difference('Debt.count') do
      post :create, debt: { amount: @debt.amount, paid: @debt.paid, paid_date: @debt.paid_date, payment_id: @debt.payment_id, user_id: @debt.user_id }
    end
  ...
  test "should update debt" do
    patch :update, id: @debt, debt: { amount: @debt.amount, paid: @debt.paid, paid_date: @debt.paid_date, payment_id: @debt.payment_id, user_id: @debt.user_id }
    assert_redirected_to debt_path(assigns(:debt))
  end
